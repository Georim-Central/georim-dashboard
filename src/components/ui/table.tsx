...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn('border-t border-gray-200 bg-gray-50/80 font-medium [&>tr]:last:border-b-0', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-12 px-3 text-left align-middle font-medium text-gray-500 [&:has([role=checkbox])]:w-px [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-0.5',
      className,
    )}
    {...props}
  />
